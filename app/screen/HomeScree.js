  ...
  constructor(props) {
    ...
    this.state = {
      ...
      pitchingDataList: [
        {
          ...
          image_url:
            'https://en.wikipedia.org/wiki/Pitcher#/media/File:Noah_Syndergaard_(20697486276).jpg',
        },
        {
          title: 'Pitchingtitle',
          description: 'Pitchingdescription',
      ...
      hittingDataList: [
        {
          title: 'Hittingtitle',
          description: 'Hittingdescription',
          image_url:
            'https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg',
        },
        {
      ...
      fieldingDataList: [
        {
          title: 'Fieldingtitle',
          description: 'Fieldingdescription',
        ...
        <View>
          <ScrollView
            ...
            <Text
              ...
              style={
                this.state.flagAll == true
                  ? styles.selectedscrollItemStyle
                  : styles.unSelectedscrollItemStyle
              }>
              All
            </Text>
            <Text
          ...
          <CustomListview
            itemList={
              this.state.flagAll == true
                ...
                : this.state.flagPitching == true
                ? this.state.pitchingDataList
                : this.state.flagHittinf == true
                ? this.state.hittingDataList
                : this.state.fieldingDataList
            }
          />
        </View>
      </View>

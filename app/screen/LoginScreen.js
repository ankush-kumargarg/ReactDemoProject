...
GoogleSignin.configure({
  webClientId:
    '29711772311-mj4scrsm585gii6861kcel445ksd99m4.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
  offlineAccess: true,
});
        ...
        <View style={styles.bottom_container}>
          <View style={styles.inner_container}>
            <Text style={styles.login_text}>
              Login{this.props.route.params.name}
            </Text>
            <TextInput
            ...
            <GoogleSigninButton
              style={styles.google_button_style}
